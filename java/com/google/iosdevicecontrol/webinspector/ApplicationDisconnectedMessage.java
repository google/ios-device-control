...
/**
 * An applicationDisconnected message.
 *
 * <p>Example:
 *
 * <pre>{@code
 ...
 */
@AutoValue
public abstract class ApplicationDisconnectedMessage extends ApplicationMessage {
  /** Returns a new builder. */
  public static Builder builder() {
    return new AutoValue_ApplicationDisconnectedMessage.Builder();
  }

  /** A builder for creating applicationDisconnected messages. */
  @AutoValue.Builder
  public abstract static class Builder extends ApplicationMessage.Builder<Builder> {
    @Override
    public abstract ApplicationDisconnectedMessage build();
  }

  @Override
  public MessageSelector selector() {
    return MessageSelector.APPLICATION_DISCONNECTED;
  }
}
