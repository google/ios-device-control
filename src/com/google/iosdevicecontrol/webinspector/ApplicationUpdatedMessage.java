 ...
 */
@AutoValue
public abstract class ApplicationUpdatedMessage extends ApplicationMessage {
  /** Returns an new builder. */
  public static Builder builder() {
    return new AutoValue_ApplicationUpdatedMessage.Builder();
  }

  /** A builder for creating applicationUpdated messages. */
  @AutoValue.Builder
  public abstract static class Builder extends ApplicationMessage.Builder<Builder> {
    @Override
    public abstract ApplicationUpdatedMessage build();
  }

  @Override
  public MessageSelector selector() {
    return MessageSelector.APPLICATION_UPDATED;
  }
}
